...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException{
		...
		Servidor ser3 = new Servidor(null, "4324", "Teste 2", "teste3@gmail.com",pe.encode("1234"));
		ser3.addPerfil(Perfil.ADMIN);
		ser2.addPerfil(Perfil.CHEFE_GESTOR);
		...
		ser3.getTelefones().addAll(Arrays.asList("982819541", "30322474"));
		...
		Endereco e4 = new Endereco(null, "Avenida Floriano", "2244", null, "Centro", "281777012", ser3, c2);
		...
		ser3.getEnderecos().addAll(Arrays.asList(e4));
		
		servidorRepository.saveAll(Arrays.asList(ser1,ser2, ser3));
	}
}
